package com.freetravelapp.common;
...
public class CustomDialog extends BaseDialog {
	...
	private CustomDialog(Builder _builder) {
		...
		super(new ContextThemeWrapper(_builder.mContext,
				_builder.mDarkTheme ? R.style.LDialogs_Dark
						: R.style.LDialogs_Light));
	...
	private void setViewProperties(View[] _view, String[] _text) {
		...
		// Swap position of positive button and negative button if right to left
		// required.
		if (RTL) {
...
//			mTypeface = Typeface.createFromAsset(this.mContext.getResources().getAssets(), "fonts/Nexa_Light.otf");
		}
...
//					.getAssets(), "fonts/UbuntuTitling-Bold.ttf");
		}
		...
		public Builder positiveBackground(int _positiveBkgd) {
			this.mPositiveBackground = mContext.getResources().getDrawable(
					_positiveBkgd);
			return this;
		}
